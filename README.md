...
The purpose of the website is to encourage users to adapt a balanced lifestyle by making fitness and nutrition more accessible and easier to understand. The aim is to provide users with practical tools, helpful information and guidance that support regular exercise, healthier eating habits and overall wellbeing

The website has been designed with clean modern and user friendly layout to ensure it is easy to navigate through and accessible for a wide range of users keeping them motivated and consistent with their goals.
...
1. Users land on the homepage where they are introduced to the website and presented with a CTA button (Start your Journey) which directs them to the workout page.

2. Users can navigate to the workout page via/ the navigation bar or the start your journey CTA button on the homepage to use the stopwatch and explore a variety of exercises available.
...
- Header: Consistent with the homepage design and navigation.
- Main content: Features an interactive nutrition calculator at the top of the page, followed by informative content boxes providing nutritional guidance, tips and relevant health information.
- Footer: Matches the homepage footer for consistent user experience.
...
Both manual and automated testing methods were used throughout the development and will be used during deployment of FitForge App to ensure the website operates correctly and provides a positive user experience.
