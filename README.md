...
This website is designed to support users who want to improve their fitness and maintain a healthier lifestyle. It provides a range of tools and rescoures to help users time their workouts, make healthier nutritional choices and discover new exercises. This website is developed for people who want to improve their overall health stay active, and build healthy habits through easy to use fitness and nutritional features.
...
- As a Returning Visitor, I want to explore diffrent muscle group workouts to add variety to my daily exercise routine.
...
- As a Frequent Visitor, I want to regulary use the Macronutrient Calculator to support my fitness goals.
- As a Frequent Visitor, I want to access workout and nutrition rescoures to maintain an healthy lifestyle.
...
- As a Returning Visitor, I want to read nutritional facts and tips so I can endure peak performance without weak recovery.
...
- Homepage (index.html) - Logo, Hero section, website introduction, Start your Journey CTA button, why choose FitForge Section and chose your fitness goal section.
...
1. Users land on the homepage where there are introduced to the website and presented with a CTA button (Start your Journey) which directs them to the workout page.

2. Users can naviagte to the workout page via/ the navigation bar or the start your journey CTA button on the homepage to use the stopwatch and explore a variety of exercises available.

3. Users can visit the nutrition page via/ the navigation bar to use the Macronutrient Calculator, read nutrition tips and browse healthy meal ideas.

4. Users can navigate between all the pages using the navigation bar or return to the Homepage at any given time by using the nav bar or clicking the main logo on the top center.
